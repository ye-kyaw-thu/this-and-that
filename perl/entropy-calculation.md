...
$\begin{align} \Huge H(X) = \sum_\limits{i=1}^{n} p(x_{i}) I(x_{i}) \end{align}$   
$\begin{align} \Huge = \sum_\limits{i=1}^{n} p(x_{i}) \log_b \frac{1}{p(x_{i})} \end{align}$   
$\begin{align} \Huge = - \sum_\limits{i=1}^{n} \log_{b}p(x_{i}) \end{align}$    
